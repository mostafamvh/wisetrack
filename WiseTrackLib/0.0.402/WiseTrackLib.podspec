...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/mostafamvh/wisetrack/releases/download/0.0.401/WiseTrackLib.xcframework.zip'}
  # s.source           = { :http => 'file:///Users/mostafamovahhed/Desktop/projects/ios/WiseTrackLib/deploy/WiseTrackLib.xcframework.zip'}
